...
public class ExceptionHandlingController extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        Optional<ObjectError> objectErrorOptional =
        ...
        if (objectErrorOptional.isPresent()) {
            ...
            return buildResponseEntity(
                    status, ((FieldError) error).getField() + " field " + error.getDefaultMessage(), null, false);
        }
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        return buildResponseEntity(
                status, "Request failed! Invalid request. Please try again.", ex.getLocalizedMessage(), false);
    }
    ...
    public ResponseEntity<Object> handleSqlException(SQLException ex) {
        return buildResponseEntity(
                ...
                "Request failed! Invalid request. Please try again.",
                ex.getLocalizedMessage(),
                false);
    }

    private ResponseEntity<Object> buildResponseEntity(
            HttpStatusCode statusCode, String message, Object payload, boolean success) {
